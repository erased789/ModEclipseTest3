...
public class TileEntitySteampunkFurnace extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.steampunk_furnace";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				BlockSteampunkFurnace.setState(this.isBurning(), this.world, this.pos);
			}
		} 
